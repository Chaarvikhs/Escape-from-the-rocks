...
game.showLongText("The rules are simple. When the rock comes to hit you, press the \"A\" button on the controller or press the up button to release the knife at the rocks and to escape from them. continue to release the knife when the rocks come to hit you. you will also see that every time you release the knife the green colour status bar level decreases and when the rock hits you the upper status bar level increses.when the upper status bar is fully decreased and the knives are still left after releasing the knives at the rocks , YOU WIN", DialogLayout.Full)
